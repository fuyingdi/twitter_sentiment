...
train_data = list(map(lambda kv:(int(kv[0]),kv[1]), [line.split(', ') for line in open("out.dat")]))
test_data = []
for i in range(100):
    index = random.randint(1000,4000)
...
# # dataset = pandas.read_csv("./out.dat")
# # _ = dataset[['tweet']].values
# # datas = [data[0] for data in _]
# # _ = dataset[['label']].values
# # y = [data[0] for data in _]
...
print(accuracy_score(_res,test_scores))
